"""ASGI entry: the minimal translational-visualization Supernet."""
...
os.environ.setdefault("CLOSURE_ENVIRONMENT", "production")
os.environ.setdefault("CLOSURE_PROJECTION_ONLY_MODE", "true")
