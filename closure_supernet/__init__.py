...
shared architecture, selector, anatomy-tree, classical value-flow, and
scheme-free relative-renormalization readings are lenses rather than parallel
runtimes. Natural-form determination requires a rigidity receipt and never emits
TRUE merely because the relation became rigid.
"""
...
from . import trading_runtime as _trading_runtime
from . import renormalization_runtime as _renormalization_runtime
